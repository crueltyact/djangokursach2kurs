        ...
        'universal_competences': [
                ...
                },
                {
                    ...
                    'indicators': [
                        ...
                        'УК-5.2. Уметь:',
                        [
                            'Вести коммуникацию в мире культурного многообразия'
                        ],
                        'УК-5.3. Владеть:',
                        [
                            'Способами анализа и пересмотра своих взглядов в случае разногласий и конфликтов в '
            ...
            [
                {
                    ...
                    'competency_name': 'Способен решать стандартные задачи профессиональной деятельности на основе информационной и '
                    ...
                    'indicators': [
                        'ОПК-3.1. Знать:',
                        [
                            'методы и средства решения стандартных задач профессиональной деятельности с применением '
                            'информационно-коммуникационных технологий и с учетом основных требований информационной '
                            'безопасности'
                        ],
                        'ОПК-3.2. Уметь:',
                        [
                            'Прешать стандартные задачи профессиональной деятельности на основе информационной и '
                            'библиографической культуры с применением информационно-коммуникационных технологий и с '
                            'учетом основных требований информационной безопасности',
                        ],
                        'ОПК-3.3. Владеть:',
                        [
                            'методами поиска и анализа информации для подготовки документов, обзоров, рефератов, '
                            'докладов, публикаций, на основе информационной и библиографической культуры, '
                ...
                },
                {
                    ...
                    'competency_name': 'Способен принимать участие в реализации профессиональных коммуникации с заинтересованными '
                    ...
                    'indicators': [
                        ...
                        'ОПК-9.2. Уметь:',
                        [
                            'Осуществлять взаимодействие с заказчиком в процессе реализации проекта',
                        ],
                        'ОПК-9.3. Владеть:',
                        [
